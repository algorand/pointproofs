...
#[no_mangle]
pub extern fn vcp_free_g1(g1: *mut ffi::c_void) {
  unsafe {
    Box::from_raw(g1);
  }
}
...
#[no_mangle]
pub extern fn vcp_g1_to_bytes(g1: *const ffi::c_void, pout: *mut u8) {
...
#[no_mangle]
pub extern fn vcp_commit(prover: *const ffi::c_void, values: *const vcp_value, nvalues: libc::size_t) -> *mut ffi::c_void {
...
#[no_mangle]
pub extern fn vcp_prove(prover: *const ffi::c_void, values: *const vcp_value, nvalues: libc::size_t, idx: libc::size_t) -> *mut ffi::c_void {
  let pprover = unsafe { &*(prover as *const super::ProverParams) };
  let pvalues = unsafe { slice::from_raw_parts(values, nvalues) };
  let vvalues: Vec<_> = pvalues.iter().map(vcp_value_slice).collect();
...
#[no_mangle]
pub extern fn vcp_proof_update(prover: *const ffi::c_void, proof: *const ffi::c_void, idx: libc::size_t, changed_idx: libc::size_t, val_old: vcp_value, val_new: vcp_value) -> *mut ffi::c_void {
  let pprover = unsafe { &*(prover as *const super::ProverParams) };
  let pproof = unsafe { &*(proof as *const super::G1) };
  let value_before = vcp_value_slice(&val_old);
  let value_after = vcp_value_slice(&val_new);

  let newproof = super::prove::proof_update(pprover, pproof, idx, changed_idx, value_before, value_after);
  return_g1(&newproof)
}

#[no_mangle]
pub extern fn vcp_commit_update(prover: *const ffi::c_void, com: *const ffi::c_void, changed_idx: libc::size_t, val_old: vcp_value, val_new: vcp_value) -> *mut ffi::c_void {
  let pprover = unsafe { &*(prover as *const super::ProverParams) };
  let pcom = unsafe { &*(com as *const super::G1) };
  let value_before = vcp_value_slice(&val_old);
  let value_after = vcp_value_slice(&val_new);

  let newcom = super::commit::commit_update(pprover, pcom, changed_idx, value_before, value_after);
  return_g1(&newcom)
}

#[no_mangle]
pub extern fn vcp_verify(verifier: *const ffi::c_void, com: *const ffi::c_void, proof: *const ffi::c_void, val: vcp_value, idx: libc::size_t) -> bool {
