...
#[repr(C)]
pub struct pointproofs_pp_bytes_dynamic {
    data: *mut u8,
    len: usize,
}
...
#[repr(C)]
pub struct pointproofs_vp_bytes_dynamic {
    data: *mut u8,
    len: usize,
}
...
#[repr(C)]
#[derive(Clone)]
pub struct pointproofs_commitment_bytes_dynamic {
...
#[repr(C)]
#[derive(Clone)]
pub struct pointproofs_proof_bytes_dynamic {
    pub(crate) data: *mut u8,
    pub(crate) len: usize,
}
...
#[no_mangle]
pub unsafe extern "C" fn pointproofs_pp_serial_dynamic
(
    pprover: pointproofs_pp,
    bytes: *mut pointproofs_pp_bytes_dynamic,
) -> i32 {
    ...
    *bytes = pointproofs_pp_bytes_dynamic { data, len };
    0
}

#[no_mangle]
pub unsafe extern "C" fn active_pointproofs_pp_free(buf: pointproofs_pp_bytes_dynamic) {
    let s = unsafe { std::slice::from_raw_parts_mut(buf.data as *mut u8, buf.len) };
    unsafe {
...
#[no_mangle]
pub unsafe extern "C" fn pointproofs_pp_deserial_dynamic(
    mut pprover: pointproofs_pp_bytes_dynamic,
    prover: *mut pointproofs_pp,
) -> i32 {
    let s: &mut [u8] = unsafe { std::slice::from_raw_parts_mut(pprover.data as *mut u8, pprover.len) };
...
/// Serializing a prove parameter into bytes
#[no_mangle]
pub unsafe extern "C" fn pointproofs_vp_serial_dynamic(
    pverifier: pointproofs_vp,
    bytes: *mut pointproofs_vp_bytes_dynamic,
) -> i32 {
    ...
    let len = boxed_buf.len();
    std::mem::forget(boxed_buf);
    *bytes = pointproofs_vp_bytes_dynamic { data, len };
    0
}

#[no_mangle]
pub unsafe extern "C" fn active_pointproofs_vp_free(buf: pointproofs_vp_bytes_dynamic) {
    let s = unsafe { std::slice::from_raw_parts_mut(buf.data as *mut u8, buf.len) };
    unsafe {
         Box::from_raw(s as *mut [u8]);
    }
...
#[no_mangle]
pub unsafe extern "C" fn pointproofs_vp_deserial_dynamic(
    mut pverifier: pointproofs_vp_bytes_dynamic,
    verifier: *mut pointproofs_vp,
) -> i32 {
    let s: &mut [u8] = unsafe { std::slice::from_raw_parts_mut(pverifier.data as *mut u8, pverifier.len) };
...
#[no_mangle]
pub unsafe extern "C" fn pointproofs_commit_serial_dynamic(
    commit: pointproofs_commitment,
    bytes: *mut pointproofs_commitment_bytes_dynamic,
) -> i32 {
    ...
    let len = boxed_buf.len();
    std::mem::forget(boxed_buf);
    *bytes = pointproofs_commitment_bytes_dynamic { data, len };
    0
}

#[no_mangle]
pub unsafe extern "C" fn active_pointproofs_commit_free(buf: pointproofs_commitment_bytes_dynamic) {
    let s = unsafe { std::slice::from_raw_parts_mut(buf.data as *mut u8, buf.len) };
    unsafe {
         Box::from_raw(s as *mut [u8]);
    }
...
#[no_mangle]
pub unsafe extern "C" fn pointproofs_commit_deserial_dynamic(
    mut commit_bytes: pointproofs_commitment_bytes_dynamic,
    commit: *mut pointproofs_commitment,
) -> i32 {
    let s: &mut [u8] = unsafe { std::slice::from_raw_parts_mut(commit_bytes.data as *mut u8, commit_bytes.len) };
...
#[no_mangle]
pub unsafe extern "C" fn pointproofs_proof_serial_dynamic(
    proof: pointproofs_proof,
    bytes: *mut pointproofs_proof_bytes_dynamic,
) -> i32 {
    ...
    let len = boxed_buf.len();
    std::mem::forget(boxed_buf);
    *bytes = pointproofs_proof_bytes_dynamic { data, len };
    0
}

#[no_mangle]
pub unsafe extern "C" fn active_pointproofs_proof_free(buf: pointproofs_proof_bytes_dynamic) {
    let s = unsafe { std::slice::from_raw_parts_mut(buf.data as *mut u8, buf.len) };
    unsafe {
         Box::from_raw(s as *mut [u8]);
    }
...
#[no_mangle]
pub unsafe extern "C" fn pointproofs_proof_deserial_dynamic(
    mut proof_bytes: pointproofs_proof_bytes_dynamic,
    proof: *mut pointproofs_proof,
) -> i32 {
    let s: &mut [u8] = unsafe { std::slice::from_raw_parts_mut(proof_bytes.data as *mut u8, proof_bytes.len) };
...
impl Default for pointproofs_pp_bytes_dynamic {
    fn default() -> Self {
        pointproofs_pp_bytes_dynamic { data: std::ptr::null_mut(), len: 0 }
    }
}

impl Default for pointproofs_vp_bytes_dynamic {
    fn default() -> Self {
        pointproofs_vp_bytes_dynamic { data: std::ptr::null_mut(), len: 0 }
    }
}
...
impl Default for pointproofs_commitment_bytes_dynamic {
    fn default() -> Self {
...
impl Default for pointproofs_proof_bytes_dynamic {
    fn default() -> Self {
