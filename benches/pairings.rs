...
benchmark_group!(benches, bench_com_pairings, bench_prove_pairings, bench_verify_pairings, bench_commit_update_pairings, bench_proof_update_pairings);
...
fn bench_com_pairings(b: &mut Bencher) {
    let n = 1000usize;
...
fn bench_prove_pairings(b: &mut Bencher) {
    let n = 1000usize;
...
fn bench_verify_pairings(b: &mut Bencher) {
    let n = 1000usize;
...
fn bench_commit_update_pairings(b: &mut Bencher) {
    let n = 1000usize;
...
// Does not include to/from bytes conversion, because this is supposed to be a local operation
fn bench_proof_update_pairings(b: &mut Bencher) {
    let n = 10;//1000usize;
