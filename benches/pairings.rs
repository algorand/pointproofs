...
//     });
//
//     let bench = bench.with_function("bench_ti_512", move |b| {
//         let commit = Commitment {
//             ciphersuite: 0,
//             commit: pairing::bls12_381::G1::one(),
//         };
...
//     });
//
//     let bench = bench.with_function("bench_ti_1024", move |b| {
//         let commit = Commitment {
//             ciphersuite: 0,
//             commit: pairing::bls12_381::G1::one(),
//         };
...
fn bench_ti(c: &mut Criterion) {
    let bench = Benchmark::new("bench_ti_new_128", move |b| {
        ...
        b.iter(|| {
            let _t = veccom::pairings::hash_to_field_veccom::hash_to_ti(&commit, &index, &values);
        });
    });
